...
<table>
  <tr>
    ...
    <td><b class="error">Для аватарки горизонт должен быть 200px(200x200)</b><br /><b class="staradmin">*</b><input type="file" id="ava" name="ava" /></td>
  </tr>
  <tr>
  ...
  <table> 
    ...
    <tr>
      <td><input type="text" id="text" name="t1" <?php if(isset($t1)) { echo 'value="'.$t1.'"'; } else { echo 'value="Тип"';} ?> size="20" /></td>
      <td><input type="text" id="text" name="o1" value="<?php echo $o1; ?>" size="50" /></td>
    </tr>  
    <tr>
      <td><input type="text" id="text" name="t2" <?php if(isset($t1)) { echo 'value="'.$t2.'"'; } else { echo 'value="Размеры"';} ?> size="20" /></td>
      <td><input type="text" id="text" name="o2" value="<?php echo $o2; ?>" size="50" /></td>
    </tr>
    <tr>
      <td><input type="text" id="text" name="t3" <?php if(isset($t1)) { echo 'value="'.$t3.'"'; } else { echo 'value="Управление"';} ?> size="20" /></td>
      <td><input type="text" id="text" name="o3" value="<?php echo $o3; ?>" size="50" /></td>
    </tr>
    <tr>
      <td><input type="text" id="text" name="t4" <?php if(isset($t1)) { echo 'value="'.$t4.'"'; } else { echo 'value="Время"';} ?> size="20" /></td>
      <td><input type="text" id="text" name="o4" value="<?php echo $o4; ?>" size="50" /></td>
    </tr>
    <tr>
      <td><input type="text" id="text" name="t5" <?php if(isset($t1)) { echo 'value="'.$t5.'"'; } else { echo 'value="Дальность"';} ?> size="20" /></td>
      <td><input type="text" id="text" name="o5" value="<?php echo $o5; ?>" size="50" /></td>
    </tr>
    <tr>
      <td><input type="text" id="text" name="t6" <?php if(isset($t1)) { echo 'value="'.$t6.'"'; } else { echo 'value="Количество каналов"';} ?> size="20" /></td>
    ...
    <tr>
      <td colspan="2"><b class="error">Для картинки горизонт должен быть 400px!</b><br /><b class="staradmin">*</b><input type="file" id="img1" name="img1" size="20" /></td>
    </tr>
  </table>
</div>
<div id="k">
  <table>
    ...
    <tr>
      <td><input type="text" id="text" name="k1" <?php if(isset($k1)) { echo 'value="'.$k1.'"'; } else { echo 'value="Пульт управления"';} ?> size="30" /></td>
    </tr>  
    <tr>
      <td><input type="text" id="text" name="k2" <?php if(isset($k2)) { echo 'value="'.$k2.'"'; } else { echo 'value="Аккумулятор"';} ?> size="30" /></td>
    </tr>
    <tr>
      <td><input type="text" id="text" name="k3" <?php if(isset($k3)) { echo 'value="'.$k3.'"'; } else { echo 'value="Зарядное устройство"';} ?> size="30" /></td>
    </tr>
    <tr>
